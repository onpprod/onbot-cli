...
7. Git, hooks, tools locais e comandos customizados.
8. Validacao final e preparo de release.
...
| M3 - Agente funcional | 06 | LLM, planejamento e workflows operam sobre as primitivas seguras. |
